...
var clientId = "644edf81174f14822070";
var gatekeeperUrl = "https://umod-gatekeeper.herokuapp.com/authenticate/";
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.error === 'bad_code') {
                    ...
                    window.location = 'https://umod.org' + window.location.pathname;
                    return true;
                }
            },
            error: function (err) {
...
function checkAccess() { // TODO: Might need to add a callback
    if (accessToken == null || accessToken === undefined) {
        if (getParameter('code') == null) {
            ...
            var redirectUrl = 'https://umod.org' + window.location.pathname;
...
function createIssue(repo, form) {
    ...
    $.ajax({
        ...
        success: function(data) {
            window.location = 'https://umod.org' + window.location.pathname + '/' + data.number;
